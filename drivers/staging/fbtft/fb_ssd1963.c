/*
 * FB driver for the SSD1963 LCD Controller
 *
 * Copyright (C) 2018 Kieran Evans
 *
 * Based on fb_ssd1289.c - (C)2013 Noralf Tronnes
 *
...
FBTFT_REGISTER_DRIVER(DRVNAME, "solomon,ssd1963", &display);

MODULE_ALIAS("spi:" DRVNAME);
MODULE_ALIAS("platform:" DRVNAME);
MODULE_ALIAS("spi:ssd1963");
MODULE_ALIAS("platform:ssd1963");

MODULE_DESCRIPTION("FB driver for the SSD1963 LCD Controller");
MODULE_AUTHOR("Kieran Evans");
MODULE_LICENSE("GPL");
