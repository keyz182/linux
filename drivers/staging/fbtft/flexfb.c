...
static const s16 ssd1963_init[] = {
	-1,0xE2,0x23,0x02,0x04,
	-1,0xE0,0x01,
	-2,10,
	-1,0xE0,0x03,
	-2,10,
	-1,0x01,
	-2,100,
	-1,0xE6,0x04,0x93,0xE0,
	-1,0xB0,0x00,0x00,0x03,0x1f,0x01,0xdf,0x00,
	-1,0xB4,0x03,0xA0,0x00,0x2E,0x30,0x00,0x0f,0x00,
	-1,0xB6,0x02,0x0D,0x00,0x10,0x10,0x00,0x08,
	-1,0xBA,0x05,
	-1,0xB8,0x07,0x01,
	-1,0x36,0x00,
	-1,0xf0,0x03,
...
static const struct flexfb_lcd_controller flexfb_chip_table[] = {
	...
	},
	{
		...
		.setaddrwin = 2,
		.regwidth = 16,
		.init_seq = ssd1963_init,
		.init_seq_sz = ARRAY_SIZE(ssd1963_init),
	},
};
